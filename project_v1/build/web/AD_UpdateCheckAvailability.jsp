    ...
    <div id="main-wrapper">
       ...
       <div class="content-body">
        ...
        ResultSet rs = st.executeQuery(query);//5- Execute query
           ...
           out.println("<th align=\"center\" colspan=\"3\"><strong>ACTION</strong></th>");
           out.println("</tr>");
           ...
           while(rs.next()){//6- process the result
                 ...
                 out.println("<td align=\"center\"><form method=post>"
                         ...
                         +"<td><input type='submit' value='delete' formaction='AD_DELETE?type="+type+"&id="+rs.getString(1)+"'></td>"
                         +"<td><input type='submit' value='update' formaction='AD_UpdateItem?type="+type+"&id="+rs.getString(1)+"'></td>"
                         + "</form>");
