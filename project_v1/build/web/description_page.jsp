       ...
       <div class="content-body">
           ...
           %>
            ...
            <%
                   ...
                   out.println("<tr rowspan=\"8\"><td colspan=\"2\"><p><br>"+Item.getDescription()+"</p></td></tr></table><br><br>");
                   
                
                %>   
                <div>
                <form method="POST">
                <button class="btn btn--pill btn--green" type="submit" formaction="reservation.jsp">RESERVE</button>
                <button class="btn btn--pill btn--green" type="submit" formaction="addwishlist">ADD WISHLIST</button></form>
                  <!-- #/ container -->   
                </div>
        </div>
