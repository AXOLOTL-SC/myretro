...
public final class PickupDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      out.write("        ");
        ...
        ResultSet rs = st.executeQuery(query);//5- Execute query
           ...
           while(rs.next()){//6- process the result
                 out.println("<tr>");
                 out.println("<td alighn=\"center\">"+rs.getString(4)+"</td>");
